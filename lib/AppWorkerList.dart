import 'package:budget_worker/AppWorkerData.dart';
...
class AppWorkerList extends StatelessWidget {
  final String text , cost;
  const AppWorkerList({Key? key, required this.text, required this.cost}) : super(key: key);
                          ...
                          return Card(
                            ...
                            child: Column(children: [
                              ListTile(
                                ...
                                onTap: (){
                                  Navigator.push(context , MaterialPageRoute(builder: (context) => AppWorkerData(text : text , cost : cost , uid : data['uid'])));
