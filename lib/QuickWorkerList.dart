import 'package:budget_worker/QuickWorkerData.dart';
...
class QuickWorkerList extends StatelessWidget {
  final String text , cost;
  const QuickWorkerList({Key? key, required this.text, required this.cost}) : super(key: key);
                          ...
                          return Card(
                            ...
                            child: Column(children: [
                              ListTile(
                                ...
                                onTap: (){
                                  Navigator.push(context , MaterialPageRoute(builder: (context) => QuickWorkerData(text : text , cost : cost , uid : data['uid'])));
