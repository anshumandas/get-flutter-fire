...
class QuickWorkerData extends StatefulWidget {
  final String text , cost , uid ;
  QuickWorkerData({Key? key, required this.text, required this.cost , required this.uid});

  @override
  State<QuickWorkerData> createState() => _QuickWorkerData(text , cost , uid);
}

class _QuickWorkerData extends State<QuickWorkerData> {
  String text , cost , uid;
  _QuickWorkerData(this.text , this.cost , this.uid);
