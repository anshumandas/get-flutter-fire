...
class CleanWorkerData extends StatefulWidget {
  final String text , cost , uid ;

  CleanWorkerData({Key? key, required this.text, required this.cost , required this.uid});


  @override
  State<CleanWorkerData> createState() => _CleanWorkerDataState(text , cost , uid);
}

class _CleanWorkerDataState extends State<CleanWorkerData> {
  String text , cost , uid;
  _CleanWorkerDataState(this.text , this.cost , this.uid);
